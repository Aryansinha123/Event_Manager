...
export default function Navbar() {
  ...
  return (
    <nav
      className="flex items-center justify-between p-4 bg-gray-800 text-white sticky top-0 z-50 px-4 md:w-[85vw] w-[75vw]"
      style={{ height: "64px" }} // Explicitly set navbar height
    >
      <h1 className="text-xl font-semibold md:ml-9 ml-18">Admin Dashboard</h1>
