      ...
      <div className="max-w-7xl mx-auto px-4 sm:px- lg:px-0 py-0">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            ...
            <Link
              href="/"
              className={`text-2xl font-bold bg-gradient-to-r ${isScrolled
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              className={`group flex items-center gap-3 px-4 py-2 rounded-xl transition-all duration-200 hover:scale-105 ${isScrolled
            ...
            >
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${isScrolled
                ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white'
                : 'bg-gradient-to-r from-purple-400 to-pink-400 text-white'
                }`}>
                {getUserInitials(user.name)}
              </div>
              <span className={`hidden sm:block font-medium ${isScrolled ? 'text-gray-700' : 'text-white'
                }`}>
                {user.name}
              </span>
              <svg
