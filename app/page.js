...
// const Navbar = () => (
//   <nav className="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-xl border-b border-white/20 px-4 py-3">
...
//         <button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 rounded-lg">Sign Up</button>
//       </div>
//     </div>
//   </nav>
// );
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-8">
                  {filteredEvents.map((event, index) => (
                    ...
                    >
                      {/* Premium Badge */}
                      <div className="absolute top-3 lg:top-4 left-3 lg:left-4 z-20 bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-xs font-bold px-2 lg:px-3 py-1 rounded-full shadow-lg">
                        ⭐ FEATURED
                      </div>
                      ...
                      <div className="relative overflow-hidden">
                        ...
                        />
                        <div className="absolute top-3 lg:top-4 right-3 lg:right-4 bg-white/20 backdrop-blur-sm rounded-xl lg:rounded-2xl px-3 lg:px-4 py-1.5 lg:py-2 text-white font-bold shadow-lg border border-white/30">
