...
//                 message.includes('success') || message.includes('Success') || message.includes('created') || message.includes('registered')
...
//           <p>Secure registration with encrypted data protection</p>
//         </div>
//       </div>
//     </div>
//   );
// }
// app/customer/register/page.js (or pages/customer/register.js if using pages router)
